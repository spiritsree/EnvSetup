...
function! ChangeStatuslineColor()
  if (mode() =~# '\v(n|no)')
    exe 'hi User2 cterm=bold ctermfg=209 ctermbg=238 guibg=#444444 guifg=#ff875f'
  elseif (mode() =~# '\v(v|V)' || g:currentmode[mode()] ==# 'V·Block' || get(g:currentmode, mode(), '') ==# 't')
    exe 'hi User2 cterm=bold ctermfg=107 ctermbg=36 guibg=#00af87 guifg=#87af5f'
  elseif (mode() ==# 'i')
    exe 'hi User2 cterm=bold ctermfg=36 ctermbg=124 guibg=#af0000 guifg=#00af87'
  else
    exe 'hi User2 cterm=bold ctermfg=190 ctermbg=90 guibg=#870087 guifg=#d7ff00'
  endif
...
set statusline+=%1*]%*                                                      " Separator
set statusline+=%1*[%*                                                      " Separator
set statusline+=%9*B-%n%*                                                   " [B-buffer number]
set statusline+=%1*]%*                                                      " Separator              
set statusline+=%1*[%*                                                      " Separator
set statusline+=%3*TOT:%{Buf_total_num()}%*                                 " [TOT:total buffer number]
set statusline+=%1*]%*                                                      " Separator
set statusline+=%1*[%*                                                      " Separator
...
set statusline+=%1*]%*                                                      " Separator
set statusline+=%1*\ %{exists('g:loaded_ale')?ALEGetStatusLine():''}%*
set statusline+=%1*\ %{exists('g:loaded_fugitive')?fugitive#statusline():''}%*
set statusline+=%=                                                          " Right Side
set statusline+=%1*[%*                                                      " Separator
set statusline+=%8*\ col:\ %02v\ %*                                         " Column number
set statusline+=%1*]%*                                                      " Separator
set statusline+=%1*[%*                                                      " Separator
set statusline+=%9*\ ln:\ %02l/%L\ (%3P)\ %*                                " Line number / total lines, percentage of document
set statusline+=%1*]%*                                                      " Separator

" http://vim.wikia.com/wiki/Xterm256_color_names_for_console_Vim
hi User1 cterm=None ctermfg=244 ctermbg=235 guibg=#444444 guifg=#808080
hi User2 cterm=bold ctermfg=209 ctermbg=235 guibg=#444444 guifg=#ff875f
hi User3 cterm=None ctermfg=214 ctermbg=235 guibg=#444444 guifg=#ffaf00
hi User4 cterm=bold ctermfg=169 ctermbg=235 guibg=#444444 guifg=#d75faf
hi User5 cterm=None ctermfg=208 ctermbg=235 guibg=#444444 guifg=#ff8700
hi User6 cterm=None ctermfg=178 ctermbg=235 guibg=#444444 guifg=#d7af00
hi User7 cterm=None ctermfg=74 ctermbg=235 guibg=#444444 guifg=#5fafd7
hi User8 cterm=None ctermfg=159 ctermbg=235 guibg=#444444 guifg=#afffff
hi User9 cterm=bold ctermfg=232 ctermbg=179 guibg=#444444 guifg=#080808
